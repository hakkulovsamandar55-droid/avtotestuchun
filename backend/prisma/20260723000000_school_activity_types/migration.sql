...
ALTER TYPE "ActivityType" ADD VALUE 'SCHOOL_CREATED';
ALTER TYPE "ActivityType" ADD VALUE 'SCHOOL_JOINED';
ALTER TYPE "ActivityType" ADD VALUE 'SCHOOL_APPROVED';
ALTER TYPE "ActivityType" ADD VALUE 'SCHOOL_DISABLED';
ALTER TYPE "ActivityType" ADD VALUE 'SCHOOL_DELETED';
