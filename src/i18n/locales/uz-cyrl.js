export default {
  ...
  home: {
    ...
    streakDays: "{{days}} кун",
    progressHint: "Менинг натижаларим",
    readiness: "Умумий аниқлик: {{percent}}%",
    passChance: "Ўтиш эҳтимоли",
    learningProgress: "Қамров",
    masteredLevel: "Ўзлаштирилган",
    solvedCount: "Ечилган",
  ...
  stats: {
    ...
    overallProgress: "Умумий натижа",
    questionsSolvedOf: "{{correct}} / {{total}} саволга тўғри жавоб берилди",
    noActivityYet: "Ҳали ҳеч қандай тест топширилмаган",
    overallAccuracy: "Умумий аниқлик",
    ticketsMastered: "Ўзлаштирилган билетлар",
    ticketsCovered: "Уринилган билетлар",
    byTicket: "Билетлар бўйича натижа",
    emptyState: "Статистика кўриш учун аввал бирорта билет тестини ечинг",
  },
  settings: {
    title: "Созламалар",
    language: "Тил",
